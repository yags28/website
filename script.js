...
document.querySelectorAll('a, button, .project-card, .stat-card, .research-card, .skill-tags span').forEach(el => {
...
const revealEls = document.querySelectorAll(
  ...
  '.skill-group, .project-card, .research-card, .research-interest, ' +
  '.contact-block, .stat-card'
);
...
staggerReveal('.projects-list', '.project-card', 90);
